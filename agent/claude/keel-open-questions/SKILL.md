---
name: keel-open-questions
description: Ask the owner a question inside the note where the answer belongs, as a [!question] callout with clickable options, and read the [!decision] it becomes on the next run. Use when a choice is the owner's to make (scope, naming, policy, taste, unknown facts) and work can continue without it.
---
